...
// A C++ program for Dijkstra's single source shortest path algorithm. // The program is for adjacency matrix representation of the graph

#include <stdio.h> #include <limits.h>

// Number of vertices in the graph #define V 9
...
// A utility function to print the constructed distance array int printSolution(int dist[], int n)
{
...
// Initialize all distances as INFINITE and stpSet[] as false for (int i = 0; i < V; i++)
...
// print the constructed distance array printSolution(dist, V);
}
